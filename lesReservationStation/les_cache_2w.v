...
parameter address_width       = 12 , // note that it is shortened to speed compilation
parameter word_addr_width     = 3  , // word field width
parameter group_addr_width    = 2  , // group field width
parameter tag_addr_width      = 7    // tag field width, note that it is shortened to speed compilation
)
(
input                          Clock       ,
input                          Resetn      ,
...
localparam set_addr_width = 1; // 1 bit for 2-way set associativity (2^1 = 2)
